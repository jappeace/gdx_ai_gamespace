...
class ClickController(plexer:InputMultiplexer, factory:(Entity)=>Animation, placeCallback:(Animation)=>Unit, followCallback:(Option[Animation])=>Unit)(implicit cam:Cam) extends ClickListener{
